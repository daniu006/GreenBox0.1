...
import { PLANT_CATEGORIES } from './domain/plant.entity';
...
export class CreatePlantDto {
  ...
  // Categoría validada en backend — el frontend no puede mandar una categoría inventada
  @IsString()
  @IsIn(PLANT_CATEGORIES, { message: `La categoría debe ser una de: ${PLANT_CATEGORIES.join(', ')}`})
  category: string;
...
export class UpdatePlantDto {
  ...
  @IsOptional()
  @IsIn(PLANT_CATEGORIES, {
    message: `La categoría debe ser una de: ${PLANT_CATEGORIES.join(', ')}`,
  })
  category?: string;
